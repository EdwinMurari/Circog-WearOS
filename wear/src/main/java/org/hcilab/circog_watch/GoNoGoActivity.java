...
public class GoNoGoActivity extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructionLayout = findViewById(R.id.gng_lyt_exp);
        testLayout = findViewById(R.id.gng_lyt_test);

        imgCircle = findViewById(R.id.gng_img_circle);
        warningText = findViewById(R.id.gng_warning);
...
//        String txt = getString(R.string.gng_dialog_finish_no_feedback);
    ...
    public void startGng(View view) {
